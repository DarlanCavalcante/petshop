-- Migration V13: Sistema de Pacotes (Combos e Créditos)
...
CREATE TABLE IF NOT EXISTS pacotes (
    ...
    validade_dias INT NULL COMMENT 'Apenas para tipo creditos. NULL = sem validade',
    max_usos INT NULL COMMENT 'Apenas para tipo creditos. Quantos serviços pode usar',
...
-- Tabela de relacionamento pacotes-serviços
CREATE TABLE IF NOT EXISTS pacotes_servicos (
    id_pacote_servico INT AUTO_INCREMENT PRIMARY KEY,
    id_pacote INT NOT NULL,
    id_servico INT NOT NULL,
    quantidade INT DEFAULT 1 COMMENT 'Quantas vezes este serviço está incluído no pacote',
    ...
    UNIQUE KEY uk_pacote_servico (id_pacote, id_servico)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS clientes_pacotes (
    ...
    data_validade DATE NULL COMMENT 'Calculado a partir de data_compra + validade_dias do pacote',
    usos_restantes INT NULL COMMENT 'Para tipo creditos. Decresce a cada uso',
    status ENUM('ativo', 'usado', 'expirado', 'cancelado') DEFAULT 'ativo',
    valor_pago DECIMAL(10,2) NOT NULL COMMENT 'Valor que o cliente pagou (pode ter desconto)',
    observacoes TEXT,
...
-- Tabela de histórico de uso de pacotes
CREATE TABLE IF NOT EXISTS clientes_pacotes_uso (
    id_uso INT AUTO_INCREMENT PRIMARY KEY,
    id_cliente_pacote INT NOT NULL,
    id_agendamento INT NULL COMMENT 'Agendamento que consumiu o uso',
    id_servico INT NULL COMMENT 'Serviço específico usado',
